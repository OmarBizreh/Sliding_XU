...
static const int async_read_expire = 8 * HZ;	/* ditto for async, these limits are SOFT! */
static const int async_write_expire = 32 * HZ;	/* ditto for async, these limits are SOFT! */
